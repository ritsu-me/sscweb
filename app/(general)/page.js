  ...
  return (
    <>
      <div className="grid grid-cols-8 gap-5 w-screen bg-white text-black px-10 py-5">
        ...
        <div className="bg-gray-200 col-span-3 rounded-2xl p-5 font-body">
          Spacer
        </div>
        <div className="col-span-2 rounded-2xl font-body">
          <div className="grid grid-cols-3 gap-5 font-body grid-rows-none">
        ...
        <div className="col-span-1 rounded-2xl font-body grid-rows-none">
          <div className="row-span-1 p-1 gap-3 text-center font-extrabold text-2xl">
            活動案内
          </div>
